    ...
    <main className="relative bg-white">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-gray-600 leading-[1.8]">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>1. Wie we zijn</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>2. Welke gegevens we verzamelen</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>3. Hoe we je gegevens gebruiken</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>4. Grondslag (AVG)</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>5. Bewaartermijn</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>6. Diensten van derden</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>7. Jouw rechten</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>9. Wijzigingen in dit beleid</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>10. Contact</h2>
