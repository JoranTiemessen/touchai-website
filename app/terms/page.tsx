    ...
    <main className="relative bg-transparent">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-slate-300 leading-[1.8]">
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>1. Over ons</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>2. Diensten</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>3. Kennismakingsgesprek</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>4. Betaling</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>5. Intellectueel eigendom</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>6. Vertrouwelijkheid</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>7. Aansprakelijkheid en garantie</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>8. Opzegging</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>9. Gebruik van de website</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>10. Toepasselijk recht</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>11. Wijzigingen in deze voorwaarden</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>12. Contact</h2>
