    ...
    <main className="relative bg-white">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-gray-600 leading-[1.8]">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>1. Over ons</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>2. Diensten</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>3. Kennismakingsgesprek</h2>
            <p>Een gratis kennismakingsgesprek kun je via onze website inplannen. Deze gesprekken zijn vrijblijvend en verplichten geen van beide partijen tot iets. Touch AI Agency behoudt zich het recht voor om een opdracht zonder opgaaf van reden te weigeren.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>4. Betaling</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>5. Intellectueel eigendom</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>6. Vertrouwelijkheid</h2>
          ...
          <div>
            ...
            <p className="mt-3">De resultaatgarantie die we bij een traject afgeven (de afgesproken agents draaien binnen 30 dagen op echt werk, gemeten als minstens 80% van het werk in de laatste twee weken; lukt dat niet, dan je investering terug of maximaal 15 dagen kosteloos doorwerken) staat los van deze aansprakelijkheidsbeperking en wordt per opdracht schriftelijk vastgelegd.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>8. Opzegging</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>9. Gebruik van de website</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>10. Toepasselijk recht</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>11. Wijzigingen in deze voorwaarden</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Inter Tight', sans-serif" }}>12. Contact</h2>
