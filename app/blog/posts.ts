...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "In 30 dagen live" },
      { type: "p", text: "We werken in vaste stappen: eerst een Bedrijfsscan (waar lekt de tijd weg), dan een agent-blauwdruk (welke agent lost welk lek op), daarna bouwen en koppelen we op je bestaande systemen. Je eerste agent draait op dag tien, de rest binnen dertig dagen. Vervolgens trainen we je team op adoptie en meten we elke maand de bespaarde uren." },
